...
But some options can be validated with a regular expression that can be set in PaasConfig:

Below snippet shows all options for validation and how to validate them:
