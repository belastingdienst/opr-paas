...
//+kubebuilder:rbac:groups=my.domain,resources=paas,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=my.domain,resources=paas/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=my.domain,resources=paas/finalizers,verbs=update
