...
import (
	...
	"github.com/belastingdienst/opr-paas/v2/internal/validate"
...
// revive:disable-line
// +kubebuilder:webhook:path=/validate-cpet-belastingdienst-nl-v1alpha2-paasconfig,mutating=false,failurePolicy=fail,sideEffects=None,groups=cpet.belastingdienst.nl,resources=paasconfig,verbs=create;update,versions=v1alpha2,name=vpaasconfig-v1alpha2.kb.io,admissionReviewVersions=v1
...
func validateDecryptKeysSecretExists(
	ctx context.Context,
	k8sclient client.Client,
	secretRef v1alpha2.NamespacedName,
	rootPath *field.Path,
) field.ErrorList {
	var allErrs field.ErrorList
