...
func SetupPaasConfigWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &v1alpha1.PaasConfig{}).
...
var _ admission.Validator[*v1alpha1.PaasConfig] = &PaasConfigCustomValidator{}
...
func (v *PaasConfigCustomValidator) ValidateUpdate(
	ctx context.Context,
	oPaasconfig, nPaasconfig *v1alpha1.PaasConfig,
) (warn admission.Warnings, err error) {
	var allErrs field.ErrorList
...
func validateConfigCapability(
	name string,
	capability v1alpha1.ConfigCapability,
	validations v1alpha1.PaasConfigValidations,
	rootPath *field.Path,
) field.ErrorList {
	var allErrs field.ErrorList
...
func validateAllowedQuotas(
	qs v1alpha1.ConfigQuotaSettings,
	validations v1alpha1.PaasConfigValidations,
