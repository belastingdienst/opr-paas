...
func GetConfig(ctx context.Context, client client.Client) (v1alpha2.PaasConfig, error) {
...
func GetConfigV1(ctx context.Context, client client.Client) (v1alpha1.PaasConfig, error) {
	v2config, err := GetConfig(ctx, client)
	if err != nil {
