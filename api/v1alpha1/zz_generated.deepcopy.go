...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ConfigDefaultQuotaSpec) DeepCopyInto(out *ConfigDefaultQuotaSpec) {
	{
		in := &in
		*out = make(ConfigDefaultQuotaSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigDefaultQuotaSpec.
func (in ConfigDefaultQuotaSpec) DeepCopy() ConfigDefaultQuotaSpec {
	if in == nil {
		return nil
	}
	out := new(ConfigDefaultQuotaSpec)
	in.DeepCopyInto(out)
	return *out
}
