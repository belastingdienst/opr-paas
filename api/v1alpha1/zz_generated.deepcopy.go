...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (pc *PaasConfig) DeepCopyInto(out *PaasConfig) {
	*out = *pc
...
func (pc *PaasConfig) DeepCopy() *PaasConfig {
	if pc == nil {
		return nil
	}
	out := new(PaasConfig)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (pc *PaasConfig) DeepCopyObject() runtime.Object {
	if c := pc.DeepCopy(); c != nil {
		return c
	}
	return nil
}
