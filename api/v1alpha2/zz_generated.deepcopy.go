...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ConfigResourceLabelConfig) DeepCopyInto(out *ConfigResourceLabelConfig) {
	{
		in := &in
		*out = make(ConfigResourceLabelConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigResourceLabelConfig.
func (in ConfigResourceLabelConfig) DeepCopy() ConfigResourceLabelConfig {
	if in == nil {
		return nil
	}
	out := new(ConfigResourceLabelConfig)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigResourceLabelConfigs) DeepCopyInto(out *ConfigResourceLabelConfigs) {
	*out = *in
	if in.AppSetLabels != nil {
		in, out := &in.AppSetLabels, &out.AppSetLabels
		*out = make(ConfigResourceLabelConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigResourceLabelConfigs.
func (in *ConfigResourceLabelConfigs) DeepCopy() *ConfigResourceLabelConfigs {
	if in == nil {
		return nil
	}
	out := new(ConfigResourceLabelConfigs)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PaasConfigSpec) DeepCopyInto(out *PaasConfigSpec) {
	*out = *in
	...
	in.ResourceLabels.DeepCopyInto(&out.ResourceLabels)
}
